...
export default function AfterLogin() {
  ...
  useEffect(() => {
    ...
    if (_data) {
      ...
      const slideArray = _data?.info?.slide
        ? Object.values(_data?.info?.slide)
        : [];
      const newSlideArray = slideArray.filter(
        (data) => data.s_position === "page_wallet"
      );
  ...
  const loginByTokken =async () => {
    let _res =await EncriptBase64(UseParams?.token);
    if (_res?.agentCode && _res?.username && _res?.password) {
      console.log("🚀 ~ loginByTokken ~ _res?.password:", _res?.password)
      console.log("🚀 ~ loginByTokken ~ _res?.username:", _res?.username)
      console.log("🚀 ~ loginByTokken ~ _res?.agentCode:", _res?.agentCode)
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="slip-verify-content flexCenter">
              ...
              <p>
                พบปัญหา{" "}
                <a style={{ color: "red" }}>ติดต่อฝ่ายบริการลูกค้า</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <div style={{ textAlign: "center", marginTop: 10, fontSize: 14 }}>
            <div>
              {" "}
              พบปัญหา <span>ติดต่อฝ่ายบริการลูกค้า</span>
            </div>
          </div>
          {/* <div className="button-line">
                            <div>
