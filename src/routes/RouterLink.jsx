    ...
    <>
      <Router>
        <Switch>
          ...
          <PublicRoute exact path={Const.PAGE_LOGIN_MOBILE + "affiliate"} component={LoginPageMobile} />
          <PublicRoute exact path={Const.PAGE_LOGIN_CAN_LOGIN_PLAY + "/:token"} component={LoginPageMobile} />
